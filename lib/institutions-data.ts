export const institutionsData = `01 - Ilocos Region	ABE International College of Business and Accountancy-Urdaneta City	Private HEI
...
export function parseInstitutions(data: string) {
  return data.split('\n').map(line => {
