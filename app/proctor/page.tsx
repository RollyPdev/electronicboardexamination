...
export default function ProctorDashboard() {
  ...
  return (
    <div className="space-responsive">
      <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl card-responsive text-white">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2">Welcome back, Proctor!</h1>
      ...
      <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent className="space-y-3">
            <Link href="/proctor/exams/new" className="block">
            ...
            <Link href="/proctor/results" className="block">
            ...
            <Link href="/proctor/students" className="block">
